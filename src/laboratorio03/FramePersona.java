...
public class FramePersona extends javax.swing.JFrame {
    ...
    private FrameListaPersona pantalla;
    ...
    public FramePersona() {
     ...
     public FramePersona(FrameListaPersona pantalla, Persona personaSelect) {
        initComponents();
        this.pantalla = pantalla;
        this.personaSelect = personaSelect;
        
        lblnombre.setText(this.personaSelect.getnombre());
        lblapellido.setText(this.personaSelect.getapellido());
        lbldni.setText(this.personaSelect.getdni());
    }
